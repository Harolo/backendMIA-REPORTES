...
public class EstPdfExportar {
	...
	public static ByteArrayInputStream  customerPDFReport(List<Estudiante> customers) throws MalformedURLException, IOException {
		...
		try {
			...
			Image imagen = Image.getInstance("C:\\Users\\HAROL\\Downloads\\mia.png");  
			...
			float[] medidaCeldas = {1.90f, 1.70f, 2.20f, 1.70f,3.25f, 1.70f, 1.70f, 1.70f, 1.90f, 1.70f};
			table.setWidths(medidaCeldas);
			
			
			//añadir tabla al pdf 
			Stream.of("MUNICIPIO","SEDE","INSTITTUTO","JORNADA","T.ALIMENTACION","T.ETNIA","NOMBRE","APELLIDO","GENERO","ZONA").forEach(headerTitle ->{
			...
			for (Estudiante customer : customers) {
				...
				PdfPCell sedeCell = new PdfPCell(new Phrase(String.valueOf(customer.getUnaSede())));
				...
				PdfPCell institucionCell = new PdfPCell(new Phrase(String.valueOf(customer.getUnaInstitucion())));
				...
				PdfPCell jornadaCell = new PdfPCell(new Phrase(String.valueOf(customer.getUnaJornada())));
				...
				PdfPCell tipoAlimentacionCell = new PdfPCell(new Phrase(String.valueOf(customer.getTelefono())));
				...
				PdfPCell etniaCell = new PdfPCell(new Phrase(String.valueOf(customer.getUnaEtnia())));
				...
				PdfPCell zonaCell = new PdfPCell(new Phrase(String.valueOf(customer.getDireccionRecidencia())));
